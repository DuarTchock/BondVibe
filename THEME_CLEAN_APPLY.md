...
> Ponlo en la **raíz del repo**. Objetivo: la app hoy se ve con el tema **oscuro Aurora** (fondo negro, bordes rosa neón, glow). Queremos el tema **Clean** (claro, neutro, tarjetas blancas, gradiente de marca) — el que está en `Kinlo Design System.dc.html` y en el §7 de `HANDOFF_COMMUNITY_MATCHING.md`.
...
el §7 de HANDOFF_COMMUNITY_MATCHING.md. Usa THEME_CLEAN_APPLY.md como especificación.
...
1) Centraliza tokens: crea/edita el tema en theme-tokens.js (o ThemeContext) con los valores del §2
   de THEME_CLEAN_APPLY.md. Define "clean" y ponlo como tema POR DEFECTO y único activo.
...
5) Íconos estilo Notion: usa el <Icon> central (strokeWidth 1.75, color por token). Ver
   ICONOS_NOTION_HANDOFF.md. Nada de íconos rosa hardcodeados.
