...
// Replaces system emojis (☕ ⛰ 🎵 😊) with the lucide-react-native icons the app
...
// category id (as stored in Firestore) -> lucide icon
const CATEGORY_ICON = {
  coffee: Coffee,
  outdoor: Mountain,
  music: Music,
...
// Consistent avatar frame: keeps the user's chosen emoji, but inside a branded tile
