...
```
Lee ICONOS_NOTION_HANDOFF.md en la raíz. Vas a unificar TODOS los íconos de la app Kinlo
...
---
_Fuente de verdad de estilo: `Kinlo Design System.dc.html`. Este documento es solo la guía de aplicación de íconos; el resto del sistema (color, tipografía, componentes) está en el §7 de `HANDOFF_COMMUNITY_MATCHING.md`._
