...
- 🌍 **Multilingual-First** - 4 idiomas desde el día 1 (EN, ES, DE, FR)
- 💰 **Accesible** - $15-50 por evento
- 🛡️ **Safety-Focused** - Verificación, reportes, moderación
...
- [Project Charter](./docs/sprint-0/PROJECT_CHARTER.md)
- [Lean Canvas](./docs/sprint-0/LEAN_CANVAS.md)
- [MoSCoW Prioritization](./docs/sprint-0/MOSCOW_MVP1.md)
- [User Stories](./docs/sprint-0/USER_STORIES_SPRINT1.md)
